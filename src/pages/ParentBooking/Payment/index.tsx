        ...
        return (
            <div className={styles.pageWrapper}>
                <div className={styles.container} style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div className={styles.card} style={{ textAlign: 'center', maxWidth: '500px', width: '100%' }}>
                        <div style={{ marginBottom: '24px' }}>
                            <Spin size="large" />
                        </div>
                        <h2 style={{ fontSize: '24px', fontWeight: '700', color: '#0f172a', marginBottom: '16px' }}>Đang chờ thanh toán...</h2>
                        <p style={{ color: '#475569', lineHeight: '1.6', marginBottom: '24px' }}>
                            Vui lòng hoàn tất thanh toán trong tab vừa mở.<br />
                            Trang này sẽ tự động cập nhật khi thanh toán thành công hoặc nếu bạn đóng tab PayOS.
                        </p>
                        <Button size="large" onClick={() => setWaitingForPayOS(false)}>Quay lại phương thức thanh toán</Button>
                    </div>
                </div>
            </div>
        );
